        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Comprehensive evaluation to create a personalized treatment plan.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Detoxification</h3>
              <p className="text-gray-600">Medically supervised detox to ensure safety and comfort.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Therapy</h3>
              <p className="text-gray-600">Individual and group sessions to address root causes.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Continued support for long-term recovery success.</p>
            </div>
          </div>
        </div>
      </section>
